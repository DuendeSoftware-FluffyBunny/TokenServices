...
docker build -f ./Dockerfile-OIDCConsentOrchestrator -t fluffybunny4/oidcconsentorchestrator .
docker tag  fluffybunny4/oidcconsentorchestrator:latest ghstahl/oidcconsentorchestrator:latest
