...
namespace SqlServer.Migrations.Tenant
{
    ...
    [Migration("20210130161208_OpenIdConnectAuthority")]
    partial class OpenIdConnectAuthority
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FluffyBunny.EntityFramework.Entities.AllowedSelfHelpClient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("SelfHelpUserId");

                    b.ToTable("AllowedSelfHelpClient");
                });

            modelBuilder.Entity("FluffyBunny.EntityFramework.Entities.AllowedTokenExchangeExternalService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AllowedTokenExchangeExternalService");
                });

            modelBuilder.Entity("FluffyBunny.EntityFramework.Entities.AllowedTokenExchangeSubjectTokenType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("SubjectTokenType")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("FluffyBunny.EntityFramework.Entities.AllowedSelfHelpClient", b =>
                {
                    b.HasOne("FluffyBunny.EntityFramework.Entities.SelfHelpUser", "SelfHelpUser")
                        .WithMany("AllowedSelfHelpClients")
                        .HasForeignKey("SelfHelpUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SelfHelpUser");
                });

            modelBuilder.Entity("FluffyBunny.EntityFramework.Entities.AllowedTokenExchangeExternalService", b =>
                {
                    b.HasOne("FluffyBunny.EntityFramework.Entities.ClientExtra", "Client")
                        .WithMany("AllowedTokenExchangeExternalServices")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FluffyBunny.EntityFramework.Entities.AllowedTokenExchangeSubjectTokenType", b =>
                {
                    b.HasOne("FluffyBunny.EntityFramework.Entities.ClientExtra", "Client")
                        .WithMany("AllowedTokenExchangeSubjectTokenTypes")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FluffyBunny.EntityFramework.Entities.SelfHelpUser", b =>
                {
                    b.Navigation("AllowedSelfHelpClients");
                });
            ...
            modelBuilder.Entity("FluffyBunny.EntityFramework.Entities.ClientExtra", b =>
                {
                    ...
                    b.Navigation("AllowedTokenExchangeExternalServices");

                    b.Navigation("AllowedTokenExchangeSubjectTokenTypes");
                });
