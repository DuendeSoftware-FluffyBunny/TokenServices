...
namespace OIDCConsentOrchestrator.Models.Client
{
    ...
    public class ConsentProtocolResponse
    {
        ...
        /// <returns></returns>
        public static async Task<T> FromHttpResponseAsync<T>(HttpResponseMessage httpResponse, object initializationData = null) where T : ConsentProtocolResponse, new()
        {
            var response = new T
            {
        ...
        /// <returns></returns>
        public static T FromException<T>(Exception ex, string errorMessage = null) where T : ConsentProtocolResponse, new()
        {
            var response = new T
            {
                Exception = ex,
