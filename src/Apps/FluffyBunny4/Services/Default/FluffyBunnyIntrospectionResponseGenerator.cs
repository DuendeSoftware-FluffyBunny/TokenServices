...
{
    public class FluffyBunnyIntrospectionResponseGenerator : IIntrospectionResponseGenerator
    {
        public IEventService Events { get; }

        private ILogger Logger;

        public FluffyBunnyIntrospectionResponseGenerator(
            IEventService events,
            ILogger<FluffyBunnyIntrospectionResponseGenerator> logger)
        {
            Events = events;
            Logger = logger;
        }
